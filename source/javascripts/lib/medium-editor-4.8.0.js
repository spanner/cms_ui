...
(function () {
    ...
    AnchorPreview.prototype = {
        ...
        init: function (instance) {
            ...
            this.base.options.previewContainer.appendChild(this.anchorPreview);
    ...
    MediumEditor.prototype = {
        ...
        init: function (elements, options) {
            ...
            if (!this.options.previewContainer) {
                this.options.previewContainer = this.options.ownerDocument.body;
            }
